...
//    예) 사람, 사물 등
// 객체의 요소 : 1) 속성(특징 나타냄, 90%), 2) 함수(행동, 동작)
// 비교) css 사용법
// 선택자 {
//    속성: 값;
//    속성2: 값2;
...
// TODO: 예제) 안지영 이라는 사람의 속성(특징)을 나열하고 객체를 만드세요.
// let member = {
//     name : "안지영",
...
//         배열(객체), 객체, null, undefine, 참고)symbol(1%)
// 총 6 개
// null 자료형 : 변수는 있으나 공간 비어 있는 것(js, 자바, c/c++ 등)
// TODO: 예제) 변수에 null 넣기
...
// undefined 에러가 발생함
console.log("code", dog.code);  // code 속성 정의 되지 않았음
