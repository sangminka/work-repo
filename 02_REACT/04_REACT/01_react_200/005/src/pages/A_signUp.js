//A_SignUp.js : 자식 컴포넌트
// rfce
//TODO: 리엑트에서 form 입력 양식 다루기
//TODO: 단방향바인딩(화면 바인딩), 수동 바인딩(개발자 직접 코딩)
//TODO: (정방향: 만들어낸 말)바인딩 : 변수의 값을 변경하면 -> 화면에 변경된 값이 바로 출력
//TODO: (역방향: 만들어낸 말)바인딩:화면에 값을 변경하면 -> 변수의 값을 변경해야됨(해주지 않음)
