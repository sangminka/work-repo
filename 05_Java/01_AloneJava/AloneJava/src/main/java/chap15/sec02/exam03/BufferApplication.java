 ...
 * author : GGG
 * date : 2023-10-02
 * description : 파일 복사 성능 테스트( 일반복사 vs 버퍼 사용 복사 )
 * 요약 :
 * <p>
 * ===========================================================
 * DATE            AUTHOR             NOTE
...
//        TODO: 파일 쓰기용으로 복사본 이미지 생성 : (이미지 경로 : cpyImagePath2)
        FileOutputStream fileOutputStream2
                = new FileOutputStream(cpyImgPath2);

//        TODO: 보조스트림(buffer) 적용 : new 보조스트림생성자(기본스트림)
        BufferedInputStream bufferedInputStream
                = new BufferedInputStream(fileInputStream2);   // 읽기용

        BufferedOutputStream bufferedOutputStream
                =new BufferedOutputStream(fileOutputStream2);  // 쓰기용
