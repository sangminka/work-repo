 ...
 * author : GGG
 * date : 2023-09-27
 * description : 자식 클래스 : 보조 스트림 : 문자 변환 보조 스트림
 * 요약 :
 *      보조스트림 : 다른 스트림과 연결되어 편리한 추가 기능을 제공해주는 객체
 *      예 ) 문자 변환, 입출력 속도 행상, 객체 직렬화 등
 ...
 *      3) 기본 자료형 입출력 : InputStream/OutputStream 1 byte,
 *         => DataInputStream/DataOutputStream
 *         => 기본 자료형 int,double, String 자료형을 사용해서 입출력할 수 있음
 * <p>
 * ===========================================================
 * DATE            AUTHOR             NOTE
 * —————————————————————————————
...
//      TODO: 보조스트림 기능 더하기 : new 보조 스트림(기본스트림)
