...
//      TODO: 보조 스트림 적용 : 기본 자료형 기능 추가
        DataInputStream dataInputStream = new DataInputStream(fileInputStream);

//      TODO: 반복문 실행 후 화면에 출력 : 2번실행
//            주의점 : 출력순서에 맞게 자료형을 읽어야함
        for (int i = 0; i < 2; i++) {
//            dataOutputStream.writeUTF("감자바");   // ?
//            dataOutputStream.writeDouble(90.3);   // 8 byte
//            dataOutputStream.writeInt(2);         // 4 byte
