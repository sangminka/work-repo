 ...
 *          = > url 웹브라우저 주소창에 입력되면 -> jsp페이지가 화면에 출력됨
 * <p>
 * ===========================================================
 * DATE            AUTHOR             NOTE
 * —————————————————————————————
...
//         => jsp : "/exam00/hello-dname.jsp" : 화면에 Hello JSP & SPring boot 출력
//         함수를 만들어 주세요
    @GetMapping("/exam00/hello2")
    public String Hello2(Model model) {return "/exam00/example01.jsp";}
}