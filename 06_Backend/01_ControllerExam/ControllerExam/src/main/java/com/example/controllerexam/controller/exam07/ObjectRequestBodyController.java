...
//    사용법 :  @PostMapping("/objext-variable")
//    @RequestBody 객체명 : ( vs @ModelAttribute 객체명 : jsp 사용 )
    @PostMapping("/objext-variable")
...
//       ]
    ...
    public List<Qna> getObjectRequestBody2(
            @RequestBody Qna qna
    ){
...
//       ]
    ...
    public List<Board> getObjectRequestBody3(
