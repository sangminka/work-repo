 ...
 */
@Controller
//TODO: @RequestMappung("/공통url") 함수의 url 과 합쳐져서 사용됨
//  예) @RequestMappung("/exam02") + @@GetMapping("/hello-name")
