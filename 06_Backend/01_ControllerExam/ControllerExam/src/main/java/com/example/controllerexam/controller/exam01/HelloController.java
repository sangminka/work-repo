 ...
 * author : GGG
 * date : 2023-10-05
 * description : JSP, 타입리프  :  SSR (Server Side Rendering)
 ...
 *              @GetMappint(url)함수() {return "jsp페이지명;"}
...
//      TODO  해위맵 자료구조 : (키, 값) => jsp 페이지로 변수를 (greeting, greeing2,...)
...
//    TODO: 연습 1) url : /exam01/hello2 => "exam01/example01.jsp에 "안녕 hello2 페이지 " 출력하기
//                                                                  "Springboot 처음이지"
//                                                                  "수고해!!!"
...
//    TODO: 연습 1) url : /exam01/hello3
//                 jsp : "exam01/example01.jsp에
//                 결과 :"안녕 hello2 페이지 " 출력하기
//                       "JSP 에는 JSTL "
//                       "EL 표현식이 있습니다."
@GetMapping("/exam01/hello3")
public String Hello3(Model model){
//      TODO  해위맵 자료구조 : (키, 값) => jsp 페이지로 변수를 (greeting, greeing2,...)
    model.addAttribute("greeting", "안녕 JSP 페이지");
