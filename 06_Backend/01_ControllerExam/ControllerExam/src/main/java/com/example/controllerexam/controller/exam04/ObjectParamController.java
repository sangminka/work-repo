...
//  TODO:  http://localhost:8000/exam04/object-param?id=forbob&name=kang
//    @ModelAttribute : 객체의 속성명으로 jsp 각각 전달
//      Member 클래스의 : id , name
    @GetMapping("/object-param")
    public String setObjectParam(
