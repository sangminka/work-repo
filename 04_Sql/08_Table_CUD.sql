...
-- 예) VARCHAR2(4000) : 최고크기, VARCHAR2 : 잘 안씀(1글자만 들어감)
...
-- 2) 테이블 삭제 : DROP TABLE 테이블 명
DROP TABLE DEPT_COPY;

-- 예제 5) DEPT COPY2 테이블 삭제하세요
...
-- 1)데이터 복사 DEPT_COPY (원본 : DEPARTMENT(부서)) [데이터 빼고]
CREATE TABLE DEPT_COPY
AS
SELECT * FROM DEPARTMENT
WHERE 1 = 2;
...
-- 컴럼 : DNO(NUMBER(2,0)),DNAME(VARCHAR2(14),LOC(VARCHAR2(13)
