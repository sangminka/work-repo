...
-- 예제1) SCOTT 사원보다 급여를 많이 받는 사원을 찾기위한 SQL 문을 작성하세요
-- 해결 : 1-1) 사원테이블에서 SCOTT 사원의 급여를 찾으 후에(1번)
--       2-1) 그 급여를 비교해서 많이 받는 사원을 추가로 찾아야함(2번)
-- 1번
SELECT SALARY
FROM EMPLOYEE
