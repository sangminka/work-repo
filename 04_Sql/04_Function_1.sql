...
-- 오라클 내장 함수
-- 1) 문자 함수
-- 사용법) 대문자 변환 : UPPER('Oracle mania')
--        소문자 변환 : LOWER('Oracle mania')
--        첫글자만 대문자 변환 : INITCAP('Oracle mania')
