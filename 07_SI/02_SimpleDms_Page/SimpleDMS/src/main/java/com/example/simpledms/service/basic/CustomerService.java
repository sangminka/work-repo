...
public class CustomerService {
    ...
    //    question like 검색
    public Page<Customer> findAllByFullNameContaining(String full_name, Pageable pageable){
        Page<Customer> page = customerRepository.findAllByFullNameContaining(full_name,pageable);
