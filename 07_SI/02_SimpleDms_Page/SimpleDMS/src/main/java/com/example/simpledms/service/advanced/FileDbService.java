...
public class FileDbService {
    ...
    public Page<FileDb> findAllByDnameContaining(
            String fileTitle,
            Pageable pageable) {
...
//              todo: 2) 다운로드 url 만들기
                String fileDownloadUri = ServletUriComponentsBuilder
                        .fromCurrentContextPath()       // 기본 경로 : http://localhost:8000
                        .path("/api/advanced/fileDb/")  // 추가 경로 붙임
                        .path(tmpUuid)                  // uuid 붙임
                        .toUriString();                 // 문자열 변환
//              최종 URL 예 : http://localhost:8000/api/advanced/fileDb/xxxxxiiiii
